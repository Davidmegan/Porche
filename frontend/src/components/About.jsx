...
import driftMark from "../assets/images/drift-mark-2 (1).png";
...
function About() {
  return (
    <div className="relative">
        ...
        <div>
          <div className="flex flex-col leading-none ml-5 justify-center">
            ...
            <p className="font-poppins dark:text-white  pa-2 pt-10 w-[75%] leading-6 z-10 ">
              ...
              performance, the 911 blends tradition with cutting-edge
              innovation. Unlike many sports cars that remain weekend-only
              thrills, the 911 is engineered for both exhilarating track
              experiences and daily practicality, offering a rare combination of
              luxury, power, and usability. Celebrities from Jerry Seinfeld to
              David Beckham have praised its refined design and exhilarating
              handling, calling it a "masterpiece of engineering" and "a therapy
              session on wheels." Every generation of the 911 builds on its
              heritage while enhancing performance, solidifying its place as one
              of the greatest and most beloved sports cars ever made. The 911
              represents not only Porsche’s commitment to excellence but also an
              enduring passion for the art of driving.
            </p>
          </div>
        </div>
      ...
      <img
        className="drift absolute right-40 -bottom-0 rotate-[-10deg] h-2/3"
        src={driftMark}
        alt="drift mark"
      />
    </div>
